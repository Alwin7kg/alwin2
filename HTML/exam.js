const quizData = [
  ...
  {
    question: 'What is the chemical symbol for Pottasium?',
    options: ['Au', 'Ag', 'Po', 'k'],
    answer: 'k',
  },
  
  {
    question: 'Which planet is the coldest Planet?',
    options: ['Neptune', 'Venus', 'Mercury', 'Uranus'],
    answer: 'Uranus',
  },
  {
  ...
  {
    question: 'Which is the largest District in Kerala?',
    options: ['Wayanad', 'Malapuram', 'Palakadd', 'Idukki'],
    answer: 'Idukki',
  },
];
